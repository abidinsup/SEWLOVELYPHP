...
$page_title = "Pesanan Sprei RS/Klinik";
    ...
    <main class="flex-1 p-4 md:p-8 pt-20 md:pt-8 w-full max-w-full">
        <div class="max-w-3xl mx-auto space-y-8 pb-20">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-slate-900">Pesanan Sprei RS/Klinik</h1>
                    <p class="text-slate-500 text-sm">Form pemesanan massal untuk instansi kesehatan</p>
                </div>
            </div>
            ...
            <div class="bg-emerald-50 border border-emerald-100 rounded-2xl p-4 flex items-start gap-3">
                ...
                <div>
                    <p class="text-sm font-bold text-emerald-800">Pesanan Custom Instansi</p>
                ...
                <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
                    <div class="flex items-center gap-3 mb-2">
                        <div class="w-8 h-8 bg-emerald-100 rounded-lg flex items-center justify-center">
                            <i data-lucide="hospital" class="h-4 w-4 text-emerald-600"></i>
                        </div>
                        <h3 class="font-bold text-slate-800">Data Instansi</h3>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold text-slate-600 uppercase tracking-wider">Nama RS/Klinik <span class="text-red-500">*</span></label>
                            <input type="text" id="namaInstansi" placeholder="cth: RS Mitra Keluarga" required
                        ...
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold text-slate-600 uppercase tracking-wider">Nama PIC / Bagian <span class="text-red-500">*</span></label>
                            <input type="text" id="namaPIC" placeholder="cth: Bu Sari - Bag. Pengadaan" required
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold text-slate-600 uppercase tracking-wider">No. WhatsApp PIC <span class="text-red-500">*</span></label>
                ...
                <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div id="card-belum" class="jadwal-card" onclick="toggleJadwal('belum')">
                            ...
                            <p class="card-sub">Tim admin akan menghubungi instansi</p>
                        </div>
                        ...
                        <div id="card-sudah" class="jadwal-card" onclick="toggleJadwal('sudah')">
                            ...
                            <p class="card-sub">Tim admin tinggal konfirmasi ke instansi</p>
                        </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea id="catatan" rows="4" placeholder="Ceritakan kebutuhan instansi Anda, misalnya: jumlah kamar, jenis sprei yang dibutuhkan, atau informasi lain yang relevan..."
...
document.getElementById('klinikForm').addEventListener('submit', function(e) {
    ...
    if (statusJadwal === 'sudah') {
        ...
        instruksiAdmin = `_✅ Jadwal sudah disepakati dengan instansi. Mohon tim konfirmasi ulang ke instansi. Terima kasih!_`;
    } else {
        jadwalInfo = `\n📅 *Jadwal Survey:* Belum ditentukan\n`;
        instruksiAdmin = `_📞 Jadwal belum ada. Mohon tim admin menghubungi instansi untuk konfirmasi jadwal survey. Terima kasih!_`;
    }

    const message =
        `🏥 *PENGAJUAN SURVEY SPREI RS/KLINIK*\n` +
        `━━━━━━━━━━━━━━━━━━━━━━\n\n` +
